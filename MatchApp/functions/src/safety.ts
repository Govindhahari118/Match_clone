...
/**
 * Blocking is a single trusted safety operation. The block relationship and relationship cleanup
 * are committed atomically so a client cannot end up in a half-blocked state after network loss.
 */
